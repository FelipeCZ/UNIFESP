...
public class Main {
  ...
  public static void main(String[] args) {
	args = new String[]{"--build-codegenie-index","--solr-url", "http://localhost:8080/solr","--database-url", "jdbc:mysql://localhost:3306/sourcererdb", "--database-user", "root", "--database-password", "zanichelli"};
	//args = new String[]{"--clear-index","--solr-url", "http://localhost:8080/solr"};
