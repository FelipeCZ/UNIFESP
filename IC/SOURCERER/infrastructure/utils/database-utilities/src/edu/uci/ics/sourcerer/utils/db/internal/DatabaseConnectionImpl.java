...
class DatabaseConnectionImpl implements DatabaseConnection {
  ...
  public boolean open() {
    try {
    	//JOptionPane.showMessageDialog(null, DatabaseConnectionFactory.DATABASE_URL.getValue()+"\n"+ DatabaseConnectionFactory.DATABASE_USER.getValue() +"\n"+ DatabaseConnectionFactory.DATABASE_PASSWORD.getValue());
