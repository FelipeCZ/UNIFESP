...
public class SlicerFactory {
	...
	public static final Argument<String> FILE_SERVER_URL = new StringArgument("file-server-url","http://127.0.0.1:8080/FileServer", "URL for the file server");
	...
	public static void main(String[] args) {
		Integer entityID = 8512696;//8512634;
