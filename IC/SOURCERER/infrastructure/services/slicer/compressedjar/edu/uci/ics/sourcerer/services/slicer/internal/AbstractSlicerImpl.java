      ...
      while (queue.hasMore()) {
        while (queue.hasMore()) {
          ...
          switch (entity.getEntityType()) {
            ...
            case METHOD:
            case CONSTRUCTOR:
              FelipeDebug.debug("["+entity.getEntityType()+"]:"+entity.getFqn()+ " ("+entity.getEntityID()+")");
            ...
            case ENUM:
              addContainingEntity(entity.getEntityID());
              //addUsedTypes(entity.getEntityID());//TODO THIS LINE WAS COMMENTED...
              addCalledMethods(entity.getEntityID());
      ...
      public void add(Integer entityID) {
        if (!slice.contains(entityID)) {
          ...
          if(entity.getModifiers()!=null &&
        		  Modifier.isFinal(entity.getModifiers().getValue()) && 
        		  entity.getEntityType().is(Entity.FIELD)){
        	  FelipeDebug.debug("[FINAL FIELD]:"+entity);
          }
          //TODO END OF REMOVE IF CODITION
        }
      }
